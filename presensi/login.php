        ...
        <div class="p-8 sm:p-10">
            ...
            <form id="loginForm" class="space-y-5">
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="password" id="passcode" required class="w-full pl-4 pr-12 py-3 rounded-xl bg-slate-50 border border-slate-200 focus:bg-white focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all outline-none" placeholder="••••••••">
                        <button type="button" id="togglePassword" class="absolute inset-y-0 right-0 flex items-center pr-4 text-slate-400 hover:text-blue-600 transition-colors focus:outline-none">
